...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func applicationDidFinishLaunching() {
        ...
        // listen for any sync request of the settings
        NotificationCenter.default.removeObserver(
            self,
            name: NSNotification.Name(NotificationKey.UserDefaultsPayloadFromApp.rawValue),
            object: nil
        )
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(self.updateUserDefaults(_:)),
            name: NSNotification.Name(NotificationKey.UserDefaultsPayloadFromApp.rawValue),
            object: nil
        )
